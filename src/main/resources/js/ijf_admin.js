						...
						{xtype:'button',
						  text: "Open Form",
							handler: function(){
								...
								{
									var tUrl = g_root + '/plugins/servlet/iftwl?itemId='+ijf.admin.cwfAdmin_form.testIssue+'&formId='+ijf.admin.cwfAdmin_form.name;
								}
								else
								{
									var tUrl = g_root + '/plugins/servlet/iftwl?formId='+ijf.admin.cwfAdmin_form.name;
								}
								window.open(tUrl);
							}},
						{xtype:'button',
