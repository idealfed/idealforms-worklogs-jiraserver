...
renderAttchmentListGrid:function(inFormKey,item, inField, inContainer)
{
	...
	if(canDelete)
	{
		listColumns.push({xtype: 'actioncolumn',
			  ...
			  width: 70,
			  items: [{icon: '' },{
					icon: '/download/resources/com.idealfed.utils.idealworklogs:idealworklogs-resources5/images/tree/drop-no.png',
...
renderTextbox:function(inFormKey,item, inField, inContainer)
{
    ...
    if (inField.style.indexOf('query:true')>-1)
    {
            sItems.push({
						xtype: 'button',
						icon: '/download/resources/com.idealfed.utils.idealworklogs:idealworklogs-resources5/images/magnify.png',
    ...
    else
    {
		...
		else
		{
			...
			if(inField.form.formProxy=="true")
			{
				...
				aUrl=g_root + "/plugins/servlet/iftwl";
